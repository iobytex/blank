...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("node-blank"),
	impl_name: create_runtime_str!("node-blank"),
	authoring_version: 1,
...
/// Configure the pallet-blank in pallets/blank.
impl pallet_blank::Config for Runtime {
	type Event = Event;
}
